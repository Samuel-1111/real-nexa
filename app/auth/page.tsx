  ...
  return <main className="authShell">
    <div className="authCard">
      ...
      <div className="authLinks">
        ...
        <button onClick={()=>{setError("");setNotice("");setMode(mode==="login"?"signup":"login")}}>
          {mode==="login"?"Create an account":mode==="signup"?"Already have an account? Log in":"Back to log in"}
        </button>
      </div>
